...
export const zhCn: Dict = {
  ...
  webimDesc: '通过 WebSocket 与 Nova 实时互动。',
  webimSend: '发送',
  webimOnline: '在线',
  ...
  webimSendShortcut: 'Enter 发送 · Shift+Enter 换行',
  webimWsReconnecting: '实时通道断开，正在重连；历史会在恢复后同步',
  ...
  webimRetrySend: '重新发送',
  webimHistoryRestored: '历史已恢复',
  webimHistoryLoading: '正在恢复历史…',
  webimRefreshHistory: '刷新历史',
  webimNewChat: '新建对话',
  webimClearHistory: '清空当前对话',
  webimClearHistoryConfirm: '确定从设备和当前浏览器中删除这段对话记录吗？',
  webimClearHistoryDone: '当前对话已清空。',
  webimExportHistory: '导出 Markdown',
  webimDevice: '设备',
  webimDeviceOnline: '在线',
  webimDeviceOffline: '离线',
  webimStorage: '存储',
  webimQuickPromptPins: '帮我解释这块 ESP32 开发板的引脚',
  webimQuickPromptCurrent: '这张电路图里的电流怎么走？',
  webimQuickPromptLed: '帮我检查这个 LED 接线',
  webimQuickPromptFile: '读取我刚上传的 TXT / MD 文件',
  webimModel: '模型',
  webimVision: '视觉能力',
  webimVisionSupported: '支持',
  webimVisionUnsupported: '不支持',
  webimChatConnected: 'Agent 聊天已就绪',
  webimNoBindShort: 'Agent 聊天未就绪',
  webimAttachmentReady: '已准备',
  webimAttachmentUploading: '上传中…',
  webimAttachmentWait: '附件还在上传，请完成后再发送。',
  webimAttachmentFailed: '失败',
  webimRemoveAttachment: '移除附件',
  webimAttachmentTypeError: '只支持图片、TXT 和 MD 文件。',
  webimAttachmentTooLarge: '文件超过浏览器 4 MB 限制。',
  webimAttachmentDeviceLimit: '压缩后仍超过设备上传限制。',
  ...
  agentPageDesc: '设置 Nova 的身份，以及每次启动后的默认交流方式。',
  agentIdentitySection: '身份',
  agentDisplayName: 'Agent 名称',
  agentDisplayNameHint: 'Agent 自我介绍时使用的名字。',
  agentOwnerName: '主人姓名',
  agentOwnerNameHint: '主人是独立的人，不是 Agent 自己。',
  agentOwnerAddress: '主人称呼',
  agentOwnerAddressHint: 'Nova 在对话中应当怎样称呼你。',
  agentPersonaSection: '初始人格',
  agentPersona: '人格预设',
  agentPersonaHardware: '耐心的硬件导师',
  agentPersonaHardwareDesc: '先讲清电流、引脚、接线关系和硬件风险，再给操作步骤。',
  agentPersonaConcise: '简洁的调试工程师',
  agentPersonaConciseDesc: '先给结论，再给精简的排查顺序和预期现象。',
  agentPersonaFriendly: '友好的通用助手',
  agentPersonaFriendlyDesc: '使用自然语言，遇到陌生术语时补一句解释。',
  agentPersonaCustom: '自定义',
  agentPersonaCustomDesc: '在固定安全边界内，使用你填写的交流风格。',
  agentCustomPrompt: '自定义人格说明',
  agentBytes: '字节',
  agentSafetyNote: '人格只影响语气和解释方式，不能替换工具、权限、文件处理或安全规则。',
  agentValidationRequired: 'Agent 名称、主人姓名和主人称呼都不能为空。',
  agentValidationIdentityLength: '身份字段过长，请缩短内容；中文通常会占 3 个 UTF-8 字节。',
  agentValidationCustom: '请填写自定义人格说明，或选择一个预设。',
  agentValidationCustomLength: '自定义人格说明不能超过 1023 个 UTF-8 字节。',
  agentSaveSuccess: 'Agent 设置已保存，重启设备后生效。',
  agentRestartHint: '新的身份和人格需要重启设备后才会生效',
  ...
  webreqSearchNote: '可选。如填写，Nova 可在运行中检索在线资源。',
